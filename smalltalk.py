...
_CATEGORIES: list[tuple[str, list[str]]] = [
    ...
    # 這批是這次新增的規則類別。
    ("are_you_ai", ["你是機器人嗎", "你是AI嗎", "你是不是AI", "你是不是機器人"]),
    ("good_luck", ["祝你好運", "祝你順利", "祝你一切順利"]),
    ("mothers_day", ["母親節快樂"]),
    ("fathers_day", ["父親節快樂"]),
    ("teachers_day", ["教師節快樂"]),
    ("lantern_festival", ["元宵節快樂"]),
    ("i_dont_know", ["我不知道", "不知道耶", "不太確定"]),
    ("whatever", ["隨便你", "都可以喔", "看你決定"]),
    ("what_doing", ["你在幹嘛", "你在做什麼", "在忙什麼呢"]),
    ("my_bad", ["是我不對", "我的錯", "都是我不好"]),
...
_REPLIES: dict[str, list[str]] = {
    ...
    "are_you_ai": ["對,我是AI,不是真人喔,但很樂意像朋友一樣陪你聊天。", "是的,我是AI助手,有什麼想問的都可以直接說。"],
